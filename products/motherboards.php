...
<body class="flex flex-col min-h-screen">
    ...
    <nav class="bg-gray-800 text-white py-2">
        <div class="container mx-auto">
            <a href="../home.php" class="text-white">Home</a> / <a href="./motherboards.php"
                class="text-white nav-g-cat">MotherBoards</a>
        </div>
    </nav>
