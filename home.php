...
<body class="flex flex-col min-h-screen">
    ...
    <main class="flex-grow container mx-auto mt-10 main-content relative">
        <!-- Alerts should be placed here to appear on top of content -->
        <div id="logoutAlert" class="hidden fixed top-0 left-0 right-0 bg-yellow-500 text-black text-center py-2 z-50">
            Logout successful!
        </div>
        <div id="cartAlert" class="hidden fixed top-0 left-0 right-0 bg-green-500 text-white text-center py-2 z-50">
