        ...
        <div class="card bg-white shadow-lg p-10 w-full max-w-lg lg:max-w-xl">
            ...
            <form id="registerForm">
                <div class="form-group mb-4">
                    ...
                    <input type="email" class="input input-bordered w-full" id="registerEmail" maxlength="80" required>
                </div>
                <div class="form-group mb-4">
                    <label for="registerPassword" class="block text-sm font-medium text-gray-700">Password</label>
                    <input type="password" class="input input-bordered w-full" id="registerPassword" maxlength="40"
                        required>
                </div>
                <div class="form-group mb-4">
                    <label for="registerPasswordConfirm" class="block text-sm font-medium text-gray-700">Retype
                        Password</label>
                    <input type="password" class="input input-bordered w-full" id="registerPasswordConfirm"
                        maxlength="40" required>
                </div>
                <button type="submit" class="btn btn-primary w-full mb-4">Register</button>
                <button type="button" class="btn btn-primary w-full" onclick="window.location.href='login.php'">Log
                    In</button>
            </form>
        </div>
    </div>
